...
def inference_c3d(inputs, isTraining=True):
    ...
    with tf.variable_scope('pool1') as scope:
        pool1 = region_ranking_3d(conv_bn1, [7, 7, 7, 64, 1], [1, 2, 2])
    ...
    with tf.variable_scope('pool2') as scope:
        pool2 = region_ranking_3d(conv_bn2, [5, 5, 5, 128, 1], strides=[2, 2, 2])
    ...
    with tf.variable_scope('pool3') as scope:
        pool3 = region_ranking_3d(conv_bn3, [5, 5, 5, 256, 1], strides=[2, 2, 2])
