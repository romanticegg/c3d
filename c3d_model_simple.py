...
def inference_c3d(inputs, isTraining=True):
    ...
    with tf.variable_scope('conv2') as scope:
        k2 = variable_with_weight_decay('w', shape=[3, 3, 3, 64, 128],
                                        initializer=tf.truncated_normal_initializer(stddev=math.sqrt(2.0/(64*3*3))), wd=FLAGS.weight_decay_conv)
    ...
    with tf.variable_scope('conv3') as scope:
        k3 = variable_with_weight_decay('w', shape=[3, 3, 3, 128, 256],
                                        initializer=tf.truncated_normal_initializer(stddev=math.sqrt(2.0/(3*3*128))), wd=FLAGS.weight_decay_conv)
    ...
    with tf.variable_scope('conv4') as scope:
        k4 = variable_with_weight_decay('w', shape=[3, 3, 3, 256, 256],
                                        initializer=tf.truncated_normal_initializer(stddev=math.sqrt(2.0/(3*3*256))), wd=FLAGS.weight_decay_conv)
    ...
    with tf.variable_scope('fc1') as scope:
        kfc1 = variable_with_weight_decay('w', shape=[1, 4, 4, 256, 2048],
                                        initializer=tf.truncated_normal_initializer(stddev=math.sqrt(2.0/(4*4*256))), wd=FLAGS.weight_decay_fc)
    ...
    with tf.variable_scope('fc2') as scope:
        kfc2 = variable_with_weight_decay('w', shape=[1, 1, 1, 2048, 2048],
                                        initializer=tf.truncated_normal_initializer(stddev=math.sqrt(2.0/(1*1*2048))), wd=FLAGS.weight_decay_fc)
