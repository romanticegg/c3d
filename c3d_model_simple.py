...
def inference_c3d(inputs, isTraining=True):
    ...
    with tf.variable_scope('conv2') as scope:
        k2 = variable_with_weight_decay('w', shape=[3, 3, 3, 64, 128],
                                        initializer=tf.truncated_normal_initializer(stddev=tf.contrib.layers.xavier_initializer()), wd=FLAGS.weight_decay_conv)
    ...
    with tf.variable_scope('fc1') as scope:
        kfc1 = variable_with_weight_decay('w', shape=[1, 4, 4, 256, 2048],
                                        initializer=tf.truncated_normal_initializer(stddev=tf.contrib.layers.xavier_initializer()), wd=FLAGS.weight_decay_fc)
