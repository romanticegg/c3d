...
flags.DEFINE_string('annofile_path', '/Users/zijwei/Dev/datasets/UCF101-split/trainlist01.txt',
                    'annotation file in format (filename label)[/Users/zijwei/Dev/datasets/UCF101-split/trainlist01.txt]')
flags.DEFINE_string("abs_path", '/Users/zijwei/Dev/datasets/UCF-101', "added to filename in annotation file to make a valid path")
flags.DEFINE_string('save_dir', '/Users/zijwei/Dev/datasets/UCF-101-g16/train', 'save to [/Users/zijwei/Dev/datasets/UCF-101-g16/train]')
